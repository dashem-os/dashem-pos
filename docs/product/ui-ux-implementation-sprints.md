...
Status: UX-00 a UX-08 executadas em 08/09/2026. **Não é "fundação fechada"**: há entregas publicadas e verdes, e continuam abertas as lacunas de homologação nomeadas na [UX-08](../quality/ux-08-homologacao-2026-09-08.md) — dois destinos nunca percorridos, catálogo volumoso não exercitado, concorrência de duas estações não validada pela tela. UX-13 executada em 08/09/2026. UX-09 e UX-10 planejadas; UX-11 aguarda exemplos de cálculo aprovados pelo dono, e UX-12 tem contrato proposto.
...
| UX-09, UX-10 | planejadas | — | Domínios novos: inventário, modelo, API, permissões e isolamento antes da tela |
...
| UX-12 | **contrato proposto** | — | Escopo inicial: diagnóstico do sistema e acesso ao suporte — conexão, sincronização e situação dos dispositivos. Manutenção de equipamentos vira domínio separado se houver demanda real |
