...
Status: UX-00 a UX-08 executadas em 08/09/2026. **Não é "fundação fechada"**: há entregas publicadas e verdes, e continuam abertas as lacunas de homologação nomeadas na [UX-08](../quality/ux-08-homologacao-2026-09-08.md) — dois destinos nunca percorridos, catálogo volumoso não exercitado, concorrência de duas estações não validada pela tela. UX-13, UX-09 e UX-10 executadas em 08/09/2026. UX-12 executada em 09/09/2026, e **continua aberta em dois pontos**: o canal real de suporte ainda não foi definido, e o caminho de emergência ficou fora da primeira entrega por decisão do dono. **UX-11 é a única aguardando regras de cálculo** — não é a única aberta. Os **dois destinos nunca percorridos saíram da lista** em 09/09/2026 — [Ambientes e Mesas e Provedores de pagamento](../quality/homologacao-destinos-nunca-percorridos-2026-09-09.md), com um defeito real encontrado no caminho. Fechou também, em [09/09/2026](../quality/homologacao-ultima-unidade-2026-09-09.md), a jornada de **duas estações em que a segunda encontra a unidade já reservada** — com outro defeito achado no caminho. O roteiro é sequencial: **duas inclusões simultâneas disputando a última unidade continuam sem prova**, e isso é pendência específica. **Conceder e retirar autoridade com a sessão do operador aberta** fechou em [09/09/2026](../quality/homologacao-autoridade-do-operador-2026-09-09.md), com outro defeito achado no caminho. **Catálogo volumoso** fechou em [09/09/2026](../quality/homologacao-catalogo-volumoso-2026-09-09.md), com dois defeitos achados: a página da grade custava 4,5s por causa de uma junção de saldos que a política de RLS impedia de usar índice, e o seletor de sortimento parava na letra D em silêncio. O **estado "em processamento" do TEF** fechou em [09/09/2026](../quality/homologacao-tef-em-processamento-2026-09-09.md): a tela sabia dizer que a cobrança saiu e não voltou, mas convidava a uma segunda cobrança que o servidor recusava em jargão. **Resposta tardia, repetida e reconciliação pelo worker** fecharam em [09/09/2026](../quality/homologacao-resposta-tardia-2026-09-09.md): repetir não duplica confirmação, recusa depois da confirmação não solta saldo, e o varrimento fecha a parcela travada sem refazer nada na segunda passada. Fecharam também em 09/09/2026 a **disputa simultânea pela última unidade** — corrida construída, que reprova sem o `FOR UPDATE` — e a **propagação da mudança de autoridade para a sessão aberta**, nos dois sentidos e sem recarregar. O **vínculo de maquininha pela tela** fechou em [09/09/2026](../quality/homologacao-vinculo-de-maquininha-2026-09-09.md) — pausar o vínculo tira o TEF do balcão de verdade, e o controle prova isso. Continua aberta a **transação real com provedor**, cujos requisitos, buracos de cobertura e um **bloqueador achado no levantamento** — o bridge não tem rota para saber que há cobrança esperando por ele — estão em [preparação da homologação com provedor](../quality/preparacao-homologacao-provedor-2026-09-09.md).
...
| UX-13 | **executada** em 08/09/2026; a operação diz que precisa de presença (migração 091), e a Gestão marca quem faz sozinho | [entrega](../quality/ux-13-autoridade-2026-09-08.md) · [capturas](../quality/evidence/ux-13/) · roteiro `frontend/e2e/presentation/ux13_autoridade.cjs` | Conceder a um operador e vê-lo agir sozinho **na tela** foi percorrido em [09/09/2026](../quality/homologacao-autoridade-do-operador-2026-09-09.md), com semeadura própria de credencial operacional. Segue aberta a **propagação** da mudança para uma sessão já aberta: hoje ela não chega à tela, e é o servidor que segura |
