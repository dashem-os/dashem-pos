...
Status: UX-00 a UX-08 executadas em 08/09/2026. **Não é "fundação fechada"**: há entregas publicadas e verdes, e continuam abertas as lacunas de homologação nomeadas na [UX-08](../quality/ux-08-homologacao-2026-09-08.md) — dois destinos nunca percorridos, catálogo volumoso não exercitado, concorrência de duas estações não validada pela tela. UX-09 a UX-13 planejadas; UX-11 aguarda exemplos de cálculo aprovados pelo dono.
