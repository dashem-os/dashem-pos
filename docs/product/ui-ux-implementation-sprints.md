...
| UX-12 | **contrato proposto**, aguardando o dono | [contrato](../product/ux-12-diagnostico-e-suporte-contrato.md) | O inventário achou saúde, fila e heartbeat prontos — e **nenhum deles chega ao lojista**. Achado que muda a prioridade: o acesso de suporte é pedido e aprovado pela plataforma, sem o dono do tenant ver, aprovar ou revogar. Três decisões dependem do dono: aprovação obrigatória versus caminho de emergência, se corrigir esse fluxo entra na sprint, e qual é o canal de suporte real |
