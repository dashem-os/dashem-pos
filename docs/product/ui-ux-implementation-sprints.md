...
Status em 09/09/2026: entregas UX-00 a UX-10 e UX-13 executadas, com alcance e ressalvas nas evidências; UX-11 aguarda exemplos de cálculo aprovados. UX-12 entrega diagnóstico e acesso assistido nominal; falta definir o canal real para concluir pedir ajuda. Emergência e autorização de equipe estão fora do escopo, não são bloqueios dessa primeira entrega. As jornadas de Ambientes e Mesas, configuração de provedores, vínculo de maquininha, catálogo volumoso no cenário medido, autoridade na sessão aberta, última unidade (jornada sequencial e prova concorrente no banco) e TEF simulado em processamento/resposta tardia foram percorridas. A integração TEF real NÃO está homologada: falta entrega de comandos ao bridge, bridge instalado, adapter e ambiente do provedor. Registro de pausa, decisões e sequência de retomada: [pausa técnica de 09/09/2026](pausa-tecnica-2026-09-09.md). Os relatórios anteriores são evidências datadas; este resumo e o registro de pausa orientam o estado atual.
