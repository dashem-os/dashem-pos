...
test('gives the Owner a real commercial plan catalog before tenant contracting', async () => {
  ...
  assert.match(workspace, /detail\.contracted_plan_revision/)
  assert.match(workspace, /Revisão do plano/)
  assert.match(workspace, /Catálogo atual/)
  assert.match(workspace, /proveniência/)
