...
export function DeviceManager() {
  ...
  const authorized = devices.filter((item) => item.status === 'ACTIVE' && item.authorized_at && item.authorization_expires_at && new Date(item.authorization_expires_at).getTime() > Date.now()).length
