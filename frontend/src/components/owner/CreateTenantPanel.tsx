        ...
        <div className="space-y-8 p-6 sm:p-8">
          <fieldset>
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              ...
              <label className="text-sm font-black sm:col-span-2">Área de atuação<input value={form.industry} onChange={e => set('industry', e.target.value)} placeholder="Ex.: restaurante, mercado, serviços ou moda" className={inputClass} /></label>
