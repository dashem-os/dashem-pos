...
export function OwnerConsoleShell({ me }: { me: AuthMe }) {
  ...
  return <div className="min-h-screen bg-[#f4f6f9] text-[#022444] lg:grid lg:grid-cols-[260px_minmax(0,1fr)]">
    <aside className={`${mobileNav ? 'flex' : 'hidden'} fixed inset-y-0 left-0 z-40 w-[280px] flex-col bg-[#022444] p-5 text-white shadow-2xl lg:static lg:flex lg:w-auto lg:shadow-none`}>
