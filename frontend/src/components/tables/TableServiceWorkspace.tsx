  ...
  return <section className="space-y-5 text-slate-950">
    ...
    <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_clamp(22rem,32vw,29rem)]">
      <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
        ...
        {!loading && tables.length === 0 ? <EmptyState /> : <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4">{tables.map((table) => {
