...
import {
  ...
  ReceiptText, Stethoscope, Store as StoreIcon, Tags, Users, Wallet,
} from 'lucide-react'
...
import { DiagnosticsManager } from '../components/management/DiagnosticsManager'
...
const ICONES: Record<string, React.ComponentType<{ className?: string }>> = {
  ...
  suppliers: Building2, payables: ReceiptText, diagnostics: Stethoscope,
...
function conteudoDoModulo(id: string, abrir: (destino: string) => void, disponiveis: Set<string>) {
  switch (id) {
    ...
    case 'diagnostics': return <DiagnosticsManager />
