...
CONTRACTS = [
    ...
    ("PUT", "/api/v1/identity/platform/plans/{plan_id}", "/api/v1/identity/platform/plans/${planId}`"),
    ...
    ("POST", "/api/v1/orders/{order_id}/items", "/api/v1/orders/${orderId}/items`"),
    ("PATCH", "/api/v1/orders/{order_id}/items/{item_id}", "/api/v1/orders/${orderId}/items/${itemId}`"),
    ("POST", "/api/v1/orders/{order_id}/items/{item_id}/cancel", "/api/v1/orders/${orderId}/items/${itemId}/cancel`"),
    ...
    ("GET", "/api/v1/team/employees", "/api/v1/team/employees`"),
    ("POST", "/api/v1/team/employees", "/api/v1/team/employees`"),
    ("PATCH", "/api/v1/team/employees/{employee_id}", "/api/v1/team/employees/${employeeId}`"),
    ("POST", "/api/v1/team/invitations", "/api/v1/team/invitations`"),
    ("POST", "/api/v1/team/operational", "/api/v1/team/operational`"),
    ("POST", "/api/v1/team/{membership_id}/activation", "/api/v1/team/${membershipId}/activation`"),
    ...
    ("POST", "/api/v1/operational-access/terminal/pin-activation", "/api/v1/operational-access/terminal/pin-activation`"),
    ("GET", "/api/v1/operational-access/session/context", "/api/v1/operational-access/session/context`"),
