...
def _new_contract_version(session: Session, tenant_id, actor_id, amount: Decimal) -> TenantContract:
    ...
    contract = TenantContract(
        ...
        activity_keys=list(previous.activity_keys),
        capability_entitlements=list(previous.capability_entitlements),
        limit_entitlements=dict(previous.limit_entitlements),
        storage_entitlement=dict(previous.storage_entitlement),
