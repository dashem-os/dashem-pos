...
from app.modules.channels import api as channels_api
...
# Born in its module (ADR-029 §1.2): the channel's own door.
api_router.include_router(channels_api.router, prefix="/channels", tags=["Channel Hub & External Inbox"])
