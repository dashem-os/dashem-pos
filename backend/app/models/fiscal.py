...
class FiscalDocument(SQLModel, table=True):
    ...
    document_type: FiscalDocumentTypeEnum = Field(
        default=FiscalDocumentTypeEnum.NFCE,
        sa_column=Column(EnumString(FiscalDocumentTypeEnum), nullable=False, index=True),
    )
    status: FiscalStatusEnum = Field(
        default=FiscalStatusEnum.PENDING,
        sa_column=Column(EnumString(FiscalStatusEnum), nullable=False, index=True),
    )
...
class FiscalEvent(SQLModel, table=True):
    ...
    event_type: FiscalEventTypeEnum = Field(sa_column=Column(EnumString(FiscalEventTypeEnum), nullable=False, index=True))
